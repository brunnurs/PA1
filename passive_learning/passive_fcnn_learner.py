...
from passive_learning.sampling import random_undersampling
...
def train_evaluate_model(model, x_test, x_train, y_test, y_train, do_plot=True):
    # model.fit(x_train, y_train, epochs=50, batch_size=128, verbose=verbose, class_weight={0: 1.0, 1: 19.0})
    model.fit(x_train, y_train, epochs=50, batch_size=128, verbose=verbose)
...
def create_keras_model():
    ...
    model.add(Dense(500, batch_input_shape=(None, 6189)))
